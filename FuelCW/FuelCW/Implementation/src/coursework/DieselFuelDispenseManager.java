...
public class DieselFuelDispenseManager implements FuelDispenseManager {
    ...
    public DieselFuelDispenseManager(FuelQueue fuelQueue, FuelRepository repository, float pricePerLiter, int fuelType, int dispenserId) {
    ...
    public static Customer getHighestAmountOfFuel(DateTime date) throws SQLException, ClassNotFoundException {
        Customer highestAmountOfFuel = new Customer(0, 0, 2, 0, false);
    ...
    public void totalDieselVehiclesServed(){

    }
    public void totalDieselFuelServed(){

    }
    public void dieselPayment()throws ClassNotFoundException, SQLException {
